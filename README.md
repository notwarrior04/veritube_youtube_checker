...
flowchart TD
    ...
    F --> G["5. Extract Factual Claims (Gemini 2.0 Flash / spaCy)"]
    G --> H{"Check Claims against Sources"}
    
    H -- "Cloud AI Engine" --> I["Fact Verification (Gemini 2.0 Flash + Web Grounding)"]
    H -- "Edge AI Engine" --> J["Fact Verification (Serper.dev Search + Wikipedia API + BART NLI)"]
    
    I --> K["6. Summarization & Verdict Assembly (Gemini 2.0 Flash / BART-Large-CNN)"]
    J --> K
    E --> K
